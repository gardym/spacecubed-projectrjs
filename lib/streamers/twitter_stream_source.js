...
exports.track_terms = function(db, terms) {
  start_streaming(db, 'statuses/filter', { 'track': terms });
};

exports.track_current_user = function(db) {
  start_streaming(db, 'user', { 'with': 'followings' });
};
