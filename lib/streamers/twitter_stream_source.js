...
var start_streaming = function(db, io, endpoint, params) {
...
exports.track_terms = function(db, io, terms) {
  start_streaming(db, io, 'statuses/filter', { 'track': terms });
};

exports.track_current_user = function(db, io) {
  start_streaming(db, io, 'user', { 'with': 'followings' });
};
