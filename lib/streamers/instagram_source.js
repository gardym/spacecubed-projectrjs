...
var search_instagram = function(db, io, lat, lng, start_time, end_time) {
...
var poll_instagram = function(db, io, lat, lng) {
  ...
  var next_poll = function() {
    ...
    search_instagram(db, io, lat, lng, start_time, end_time);
    start_time = end_time;
  };
...
exports.track = function(db, io, lat, lng) {
  poll_instagram(db, io, lat, lng);
};
