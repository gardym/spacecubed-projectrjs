define(['target_visualisation'], function() {

	TargetVisualisation = function(coords) {
		this.id = 'id' + Math.random().toString().replace(/\./g, '');
		this.e = $('<div class="target-visualisation target-visualisation-container"></div>').appendTo($("body"));
		this.x = coords.x;
		this.y = coords.y;
	...
	TargetVisualisation.prototype.startAnimation = function() 
	{
	};

	TargetVisualisation.prototype.stopAnimation = function() 
	{
		this.animationStopping = true;
	};

	TargetVisualisation.prototype.remove = function() 
	{
      var self = this;
	...
	TargetVisualisation.prototype._createRingElements = function(numRings) 
	{
	...
	TargetVisualisation.prototype._createRingElement = function(radiusInner, thickness) 
	{
